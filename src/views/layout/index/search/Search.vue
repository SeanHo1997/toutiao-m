...
<script>
import LinkedSuggestions from '@/views/layout/index/search/components/LinkedSuggestions.vue'
import SearchHistory from '@/views/layout/index/search/components/SearchHistory.vue'
import SearchResults from '@/views/layout/index/search/components/SearchResults.vue'
export default {
  name: 'SearchCom',
  data () {
    return {
